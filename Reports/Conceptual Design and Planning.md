...
6. The diagnostic tool shall have an LCD screen that will display the PWM signal, tachometer signal, and a user interface designed at a later date.
...
| --------         | -------                 |-------        |
| Microcontroller  | STM32L452RET6T          | $15|
